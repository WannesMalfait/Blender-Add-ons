...
instances = {
    ...
    'white_noise': [NodeInstance('White Noise Texture', [1], [0, 1], [('noise_dimensions', '1D')]),
                    NodeInstance('White Noise Texture', [0], [0, 1], [('noise_dimensions', '3D')]), ],
    ...
    'noise': [NodeInstance('Noise Texture', [1, 2, 3, 4, 5], [0, 1], [('noise_dimensions', '1D')]),
              NodeInstance('Noise Texture', [0, 2, 3, 4, 5], [0, 1], [('noise_dimensions', '3D')]), ],
    ...
    'voronoi': [NodeInstance('Voronoi Texture', [1, 2, 5], [0, 1], [('voronoi_dimensions', '1D')]),
                NodeInstance('Voronoi Texture', [0, 2, 5], [0, 1], [('voronoi_dimensions', '3D')]), ],
